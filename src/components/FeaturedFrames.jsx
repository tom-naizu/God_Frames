        ...
        {filteredFrames.map((frame, index) => (
          ...
          >
            ...
            <div className="p-5">
              ...
              <h3 className="mt-1.5 text-base font-outfit font-semibold text-spiritual-800 group-hover:text-spiritual-600 transition-colors line-clamp-1">
                {frame.title}
              </h3>
              ...
              <div className="mt-3 flex items-center justify-between">
                <div className="flex items-baseline gap-2">
                  ...
                  <span className="text-sm text-spiritual-400 line-through font-poppins">{frame.originalPrice}</span>
                </div>
              </div>

              {/* Add to Cart */}
              <button className="mt-4 w-full py-2.5 bg-gradient-to-r from-spiritual-500 to-spiritual-600 text-white font-outfit font-medium text-sm rounded-xl shadow-md shadow-spiritual-400/20 hover:shadow-spiritual-400/40 transition-all duration-300 hover:-translate-y-0.5 active:translate-y-0 flex items-center justify-center gap-2">
